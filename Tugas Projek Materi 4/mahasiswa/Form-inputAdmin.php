...
<div class="container mt-4">
    <form method="post" action="SimpanAdmin.php">
        ...
        <fieldset class="row mb-3">
            ...
            <div class="col-sm-10">
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="status" value="user" id="gridRadios1">
                    <label class="form-check-label" for="gridRadios1">User</label>
                </div>
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="status" value="admin" id="gridRadios2">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="text" name="password" class="form-control" id="inputText3" required>
            </div>
        </div>
