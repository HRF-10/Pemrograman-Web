...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
    ...
    <div class="container mt-5">
        <form action="Update.php" method="post">
            ...
            <div class="mb-3">
                <label for="inputNumber3" class="form-label">Nim</label>
                <input type="number" class="form-control" id="inputNumber3" value="<?php echo $row['nim'] ?>" onkeyup="isi_otomatis()" name="nim">
            </div>
            <div class="mb-3">
                <label for="inputText3" class="form-label">Nama</label>
                <input type="text" class="form-control" id="inputText3" value="<?php echo $row['nama'] ?>" name="nama">
            </div>
            <fieldset class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="jurusan">
                    <?php echo "<option value=" , $row['jurusan'] . ">" . $row['jurusan'] . "</option>" ?>
